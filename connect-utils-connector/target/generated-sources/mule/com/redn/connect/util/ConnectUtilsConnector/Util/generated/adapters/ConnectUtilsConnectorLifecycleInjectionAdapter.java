...
/**
 * A <code>ConnectUtilsConnectorLifecycleInjectionAdapter</code> is a wrapper around {@link ConnectUtilsConnector } that adds lifecycle methods to the pojo. This adapter also allows the injection of several Mule facilities when a MuleContext is set.
 * 
 */
@SuppressWarnings("all")
@Generated(value = "Mule DevKit Version 3.9.0", date = "2016-11-24T07:08:09+05:30", comments = "Build UNNAMED.2793.f49b6c7")
public class ConnectUtilsConnectorLifecycleInjectionAdapter
    extends ConnectUtilsConnectorMetadataAdapter
    implements MuleContextAware, Disposable, Initialisable, Startable, Stoppable
{
    ...
    {
        Logger log = LoggerFactory.getLogger(ConnectUtilsConnectorLifecycleInjectionAdapter.class);
