...
public class GetDateAsXMLGregorianCalendarMessageProcessorDebuggable
    extends GetDateAsXMLGregorianCalendarMessageProcessor
    implements DebugInfoProvider
{


    public GetDateAsXMLGregorianCalendarMessageProcessorDebuggable(String operationName) {
        super(operationName);
    }
    ...
    public List<FieldDebugInfo<?>> getDebugInfo(MuleEvent muleEvent) {
        ...
        fieldDebugInfoList.add(createDevKitFieldDebugInfo("date", "Date", (java.util.Date.class), date, muleEvent));
